				...
				<div class="card">
                    <div class="card-body">
                      <ul style="list-style-type:none;" >
						  <li><a class="btn btn-primary" href="/guru/materi/tambah" role="button">Tambah Pertemuan</a> 
						  <a class="btn btn-primary" href="/guru/absensi" role="button">Absensi Siswa</a></li>
						</ul>
                      </div>
                  </div>
			<div class="card">
