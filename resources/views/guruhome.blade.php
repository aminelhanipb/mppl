	  ...
	  <div class="row siswa">
	   ...
	   <div class="row body-pelajaran">
		 <div class="card btn" style="width: 16rem;" >
			 <img src="MTK-01.png" class="card-img-top" alt="...">
			 <a href="guru_course.html" class="btn btn-primary">10 IPA 2</a>
           </div>
			   <div class="card btn" style="width: 16rem;" >
			 <img src="MTK-01.png" class="card-img-top" alt="...">
			 <a href="#" class="btn btn-primary">11 IPA 2</a>
           </div>
		<div class="card btn" style="width: 16rem;" >
			 <img src="MTK-01.png" class="card-img-top" alt="...">
			 <a href="#" class="btn btn-primary">12 IPA 2</a>
           </div>
	 </div>	
